...
namespace AssessmentWeb
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        //    conn.Open();
        //    String query = "select count(*) from Users where userEmail ='" + Email.Text.Trim() + "'and userPass ='" + Password.Text;

        //    SqlCommand command = new SqlCommand(query, conn);

        //   // String userType = command.ExecuteScalar().ToString();
        //    int userExists = int.Parse(command.ExecuteScalar().ToString());
        //    conn.Close();
        ...
        //    conn.Open();
        //    String query = "select userType from Users where userEmail ='" + Email.Text + "'";
        ...
        protected void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            else if (isStudent != null && isStudent != "")
            {
                ...
                Session["name"] = userName;
                Response.Redirect("~/Student/Student.aspx"); // change the page
            }
            else
            {
