    ...
    public partial class AddMultipleTest : System.Web.UI.Page
    {
        ...
        protected void btnAddQuestion_Click(object sender, EventArgs e)
        {
          ...
          //  SqlCommand cmd1 = new SqlCommand("Select max(QuestionOrder) as QuesOrder from MultiQuestion where ExamID='" + ExamIDtxt.Text + "'", conn);
            ...
            string insert2 = "insert into MultiQuestion(QuestionDesc,Answer1,Answer2,Answer3,Answer4,CorrectAnswer,QuestionOrder,ExamID,EachMarks) values " +
                "('" + txtTitle.Text + "','" + txtAnswer1.Text + "','" + txtAnswer2.Text + "','" + txtAnswer3.Text + "','" + txtAnswer4.Text + "','" + ddlCorrectAnswer.SelectedItem.Text + "','" + Q
                + "','" + ExamIDtxt.Text + "','" + eachmarks + "')";
        ...
        {
            Response.Redirect("~/Tutor/CheckMultiQuetions.aspx");
        }
    }
}